...
with open('rav_yarns.csv', 'w', encoding='utf-8', newline='') as csvfile:
    writer = csv.writer(csvfile)
    # Write the header
    writer.writerow(field_names)
    
    total_rows = 0
    weights = ["thread", "cobweb", "lace", "worsted", "jumbo", "unknown"]
...
print("\nFinished writing", total_rows, "rows to rav_yarns.csv")
